    ...
    <main className="min-h-screen">
      ...
      <section id="hero" className="min-h-screen flex items-center justify-center relative overflow-hidden bg-gradient-to-br from-emerald-50 via-pink-50 to-stone-100"
        ...
        <div className="absolute inset-0 pointer-events-none overflow-hidden">
          <div className="liquid-blob w-96 h-96 -top-20 -left-20"></div>
          <div className="liquid-blob w-80 h-80 top-20 right-10"></div>
          <div className="liquid-blob w-64 h-64 bottom-40 left-1/4"></div>
          <div className="liquid-blob w-72 h-72 bottom-10 right-1/3"></div>
        </div>
